...
#    outf.write(inf.readline())
    for line in inf:
        if  not line.lstrip().startswith("#") and not line.lstrip().startswith("SET") and not line.lstrip().startswith("administrator command") and not line.lstrip().startswith("SELECT @") and line.strip() and not line.isspace():
            outf.write(line)
